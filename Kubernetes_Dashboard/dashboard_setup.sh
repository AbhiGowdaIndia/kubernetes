#!/bin/bash
if [[ "$1" == 'install' ]]; then 
    kubectl apply -f https://raw.githubusercontent.com/AbhiGowdaIndia/kubernetes/main/Kubernetes_Dashboard/kubernete-dashboard.yml
    ...
    kubectl delete -f https://raw.githubusercontent.com/AbhiGowdaIndia/kubernetes/main/Kubernetes_Dashboard/kubernete-dashboard.yml
